...
@section('title', 'Tambah Data SFO')

@section('content')
    <div class="container-fluid">
        <div class="card">
            <div class="card-body p-4">
                <h3 class="mb-4 text-center text-primary fw-bold">TAMBAH DATA SFO</h3>
                ...
                <form method="POST" action="{{ route('sfo.store') }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_sfo') is-invalid @enderror" 
                                id="tanggal_sfo" name="tanggal_sfo" value="{{ old('tanggal_sfo', date('Y-m-d')) }}" required>
                            @error('tanggal_sfo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control @error('panjang') is-invalid @enderror" 
                                    id="panjang" name="panjang" value="{{ old('panjang') }}" 
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control @error('tebal') is-invalid @enderror" 
                                    id="tebal" name="tebal" value="{{ old('tebal') }}" 
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control @error('luas') is-invalid @enderror" 
                                    id="luas" name="luas" value="{{ old('luas') }}" 
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                <option value="Unprocessed" {{ old('status') == 'Unprocessed' ? 'selected' : '' }}>Unprocessed</option>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes" 
                                placeholder="Tambahkan catatan (opsional)" rows="3">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
