    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body p-4">
                <h3 class="text-primary fw-bold mb-4">Edit Jenis Pekerjaan</h3>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control @error('nama_pekerjaan') is-invalid @enderror" 
                                id="nama_pekerjaan" name="nama_pekerjaan" value="{{ old('nama_pekerjaan', $work->nama_pekerjaan) }}" required 
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                ...
                                placeholder="Tambahkan deskripsi pekerjaan (opsional)">{{ old('deskripsi', $work->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
