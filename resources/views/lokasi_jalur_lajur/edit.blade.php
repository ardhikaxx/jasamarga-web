    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body p-4">
                <h3 class="text-primary fw-bold mb-4">Edit Lokasi</h3>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('jalur') is-invalid @enderror" 
                                id="jalur" name="jalur" value="{{ old('jalur', $location->jalur) }}" required 
                                placeholder="Contoh: KM 178-300">
                            @error('jalur')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('lajur') is-invalid @enderror" 
                                id="lajur" name="lajur" value="{{ old('lajur', $location->lajur) }}" required 
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                ...
                                placeholder="Tambahkan keterangan lokasi (opsional)">{{ old('keterangan', $location->keterangan) }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
