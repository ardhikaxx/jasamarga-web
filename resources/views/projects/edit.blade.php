    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body p-4">
                <h3 class="text-primary fw-bold mb-4">Edit Projek</h3>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_projek') is-invalid @enderror" 
                                id="nama_projek" name="nama_projek" value="{{ old('nama_projek', $project->nama_projek) }}" required>
                            @error('nama_projek')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control @error('tahun_projek') is-invalid @enderror" 
                                id="tahun_projek" name="tahun_projek" value="{{ old('tahun_projek', $project->tahun_projek) }}" 
                    ...
                    <div class="row mb-4">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror" 
                                id="lokasi" name="lokasi" value="{{ old('lokasi', $project->lokasi) }}" required>
                            @error('lokasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
